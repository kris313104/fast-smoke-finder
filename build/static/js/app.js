...
function openAdminModal() {
  ...
  _adminTags = [];
  renderAdminTags();
  document.getElementById('preview-pos').innerHTML   = '<span class="upload-hint">Click to choose file</span>';
  document.getElementById('preview-cross').innerHTML = '<span class="upload-hint">Click to choose file</span>';
  ...
  if (_currentMapId) sel.value = _currentMapId;
...
adminForm.addEventListener('submit', async e => {
  ...
  try {
    ...
    adminStatus.textContent = '✓ Lineup saved!';
